...
*/
/*
Los cambios realizados fueron el cambio de tipo de dato del apuntador *data y su asignación de memoria dinámica
la función imprime
y un par de asignaciones en ls últimas lineas
*/
...
int main (int argc, char **argv) {
    ...
    // Insertar las 27 letras del alfabeto inglés (A-Z y espacio)
    for (i = 0; i < 27; i++) {
        if ((data = (char *)malloc(sizeof(char))) == NULL)
            return 1;

        *data = (i < 26) ? ('A' + i) : ' ';  // Último carácter es espacio
