...
*/
/*
Este estuvo aparentemente más sencillo. Se añadió la captura de datos incluyendo un atoi para castear
Esa parte era algo similar a otro código visto anteriormente en el curso.
Solo se modifico la inciliazición de algunos ciclos para recorrer completo, y la captura de datos. el resto es idéntico
*/
...
int main (int argc, char **argv) {
    ...
    // Fill the linked list with values from command line
    for (i = 1; i < argc; i++) {
